...
{
  "devDependencies": {
    "remark-loader": "webpack-contrib/remark-loader#{id}/head"
  }
}
```
...
When submitting your contribution, a CLA (Contributor License Agreement) bot will come by to verify that you signed the [CLA](https://cla.js.foundation/webpack-contrib/remark-loader).
